...
namespace WallpaperForBA.Shared.Shaders {
    ...
    public class ColorKeyReplaceEffect : ShaderEffect {
        ...
        public ColorKeyReplaceEffect() {
            ...
            pixelShader.UriSource = new Uri("pack://application:,,,/WallpaperForBA.Shared;component/Shaders/ColorKeyReplaceEffect.ps", UriKind.RelativeOrAbsolute);
